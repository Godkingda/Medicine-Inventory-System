        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    System.out.print("Enter Type (tablet/injection/syrup): ");
                    String type = scanner.nextLine().trim().toLowerCase();
                    Medicine med;
                    if (type.equals("injection")) {
                        med = new Injection(id, name, qty, expiry);
                    } else if (type.equals("syrup")) {
                        med = new Syrup(id, name, qty, expiry);
                    } else {
                        med = new Tablet(id, name, qty, expiry);
                    }
                ...
                case 5:
                    ...
                    Medicine batch = new Tablet(bid, bname, bqty, bexp);
